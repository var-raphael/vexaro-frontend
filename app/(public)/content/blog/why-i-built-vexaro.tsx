export default function Body() {
  return (
    <>
      ...
      <p>
        Vexaro is my answer to that. Describe what data you want in plain English, point it at sources, and get a clean versioned API back. The infrastructure disappears. The data is just there — typed, structured, refreshed nightly, queryable, and downloadable in whatever format you need.
      </p>
      <p>
